...
function buildPrompt(scores: any, answers: any, primaryType: string): string {
  ...
  return `请根据以下"分手挽回可能性测评"结果，生成一份深度分析报告。
...
接下来，我会用最真诚的态度，帮你分析清楚：你们到底出了什么问题？对方现在是什么心理状态？你应该怎么做？以及，这段感情是否真的值得挽回。
深呼吸，我们一起面对。"
